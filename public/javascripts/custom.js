        ...
        if($(this).text() == ""){
            ...
            $.post(`/home/getDataForChart`, {
                ...
                if (data === "Fail") {
                    ...
                    $.plot($("#chart_plot_03"), [{ label: 'Amount', data: dataToPlot.reverse() }], options);
    ...
    if (window.location.pathname === '/home') {
        $.get(`/home/getDashboardData`, {}, function (data) {
            if (data === "Fail") {
                ...
                $('.top_tiles .tile:nth-child(2) h2').text(dashData.dailyAmount.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' }));
                $('.top_tiles .tile:nth-child(3) h2').text(dashData.monthlyAmount.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' }));
